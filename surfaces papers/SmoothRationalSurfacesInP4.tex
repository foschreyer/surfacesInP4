...
\item\label{schFamWiths=3} $\ge 4$ families of Schreyer surfaces of  degree $11$ and sectional genus $\pi=10$ with Betti table
$$\begin{matrix}
       & 0 & 1 & 2 & 3 & 4\\
       %\text{total:} & 1 & 12 & 26 & 20 & 5\\
      0: & 1 & . & . & . & .\\
...
So at the moment there are at least $21+2+2+4=29$ components of the Hilbert scheme of surfaces in $\PP^{4}$ whose general elements correspond to non-degenerate  smooth rational surfaces.
